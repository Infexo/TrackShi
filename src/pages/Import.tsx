...
export default function Import() {
  ...
  const promptText = `Extract the study dates and total study durations from these screenshots. Generate a CSV with two columns: 'date' (YYYY-MM-DD format) and 'hours' (HH:MM format). Return ONLY the raw CSV text.`;
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-[#0A0A0A] p-6 border border-zinc-800 rounded-none h-fit">
        ...
        <div className="bg-[#0A0A0A] p-6 border border-zinc-800 rounded-none h-fit space-y-4">
          <h2 className="text-xl font-bold uppercase tracking-widest text-zinc-100 border-b border-zinc-800 pb-4">How to import from screenshots</h2>
          <p className="text-sm text-zinc-400 font-serif italic">
            Don't want to type out your data manually? You can use AI (like ChatGPT, Claude, or Gemini) to generate a CSV for you.
          </p>
          
          <ol className="list-decimal list-inside space-y-3 text-sm font-mono text-zinc-300">
            <li>Take screenshots of your study history/stats from your current app.</li>
            <li>Go to your preferred AI chatbot.</li>
            <li>Upload your screenshots and use this prompt:</li>
          </ol>

          <div className="relative bg-[#141414] border border-zinc-800 p-4 rounded-none mt-2">
            <p className="text-xs font-mono text-zinc-400 pr-8">{promptText}</p>
            <button 
              onClick={handleCopyPrompt}
              className="absolute top-3 right-3 p-1.5 text-zinc-500 hover:text-[#FF5500] transition-colors bg-[#0A0A0A] border border-zinc-800"
              title="Copy prompt"
            >
          ...
          <ol className="list-decimal list-inside space-y-3 text-sm font-mono text-zinc-300 mt-4" start={4}>
            <li>Save the AI's output as a <code className="bg-[#141414] px-1 py-0.5 border border-zinc-800 text-[#FF5500]">.csv</code> file.</li>
